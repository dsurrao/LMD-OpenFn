console.log('saving de_cha_monthly_service_report');

/*

dataValue('data[?(@.dataElement==\'G2KD4mHCEmo\')].value')
upsertMany(
    'de_cha_monthly_service_report',
    [
        { meta_uuid: 'kwIzfzpJ82z', cha_name: 'Dominic Surraos', chss_name: 'Alex C' },
        { meta_uuid: 'plPz2j9VSIz', cha_name: 'James Test1', chss_name: 'Jim G'  },
        { meta_uuid: 'id1234', cha_name: 'New CHA 1234', chss_name: 'Jim G'},
        { meta_uuid: 'id1235', cha_name: 'New CHA 1235', chss_name: 'Jim G'},
        { meta_uuid: 'id1236', cha_name: 'New CHA 1236', chss_name: 'Jim G'},
    ]
);
*/

/* Expected state data format:
state.data = {
    "dataValues": [
        {
...
alterState(state => {
    console.log(state.data.upsertData);
    upsertMany('de_cha_monthly_service_report', state.data.upsertData);
    return state;
});
